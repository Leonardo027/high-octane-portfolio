...
const specs = [
    {
        ...
        icon: Layout,
        items: ["React.js / Next.js", "Tailwind CSS", "HTML5 & CSS3 Semântico", "JavaScript (ES6+)"],
        status: "OPTIMIZED",
    },
    {
        category: "SYSTEM LOGIC / BACK-END",
        icon: Server,
        items: ["C# / .NET (Core)", "Node.js", "Python (AI Integration)", "Lógica de Programação"],
        status: "STABLE",
    },
    {
        category: "DATABASE / INFRA",
        icon: Database,
        items: ["SQL Server / MySQL", "Git & Version Control", "Linux Environment", "API RESTful"],
        status: "RUNNING",
    },
    {
        category: "HARDWARE / IOT LAB",
        icon: Cpu,
        items: ["ESP32 / Arduino (C++)", "Automação Residencial", "Eletrônica & Soldagem", "Protocolos (MQTT/Serial)"],
        status: "ACTIVE",
    },
];
    ...
    return (
        <section id="specs" className="py-24 relative bg-void">
            ...
            <div className="max-w-7xl mx-auto px-6 mb-16">
                ...
                <h3 className="text-4xl md:text-5xl font-bold italic uppercase">
                ...
                {specs.map((spec, index) => (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h4 className="text-xl font-bold mb-4 font-mono">{spec.category}</h4>
